  ...
  return (
    <div className="store-wrapper mt-4">
      ...
      <div className="row w-50 m-auto mt-4">
        {products?.map((prod) => (
          <div className="col-md-6 mb-5" key={prod.id}>
            <div className="content">
              ...
              <img className='img-hover-zoom img-hover-zoom--xyz' src={prod?.imageUrl} alt="image_product" />
        ...
        {/* <div className='d-flex justify-content-center'><button  className='btn btn-info'>See the Cart</button></div> */}
      </div>
    </div>
  )
}
